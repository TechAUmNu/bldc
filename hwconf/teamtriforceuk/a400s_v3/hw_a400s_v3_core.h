...
#ifndef HW_A400S_V3_CORE_H_
#define HW_A400S_V3_CORE_H_

// HW Config for the A400S V3, 24 FET hardware with 3x low side shunts and redundant hardware overcurrent.
// MCU: STM32F405RGT6 LQFP-64
// Mosfets: NTMTSC1D6N10MCTXG
// Gate Drivers: 2EDF7275KXUMA1
// Shunts: 3x 0.2mOhm LR2725-24R0002F1
// Current Shunt Amp: INA4181A1 (20x)
// Ceramic: 9x 10uF 100V 2220, 16x 100uF 100V 0603
// Electrolytic: 13x 100uF 100V Polymer
// DCDC: LTC7103, ZTP7193Y, AMS1117-3.3V
// Analog reference: REF2033
// IMU: LSM6DSL
// CAN: TJA1051TK/3,118
// Peripherals: ATTiny3216 (logger, overcurrent), ATTiny1616 (Output control, overcurrent)
// EFuses: 12V TCKE812NA,RF, 5V/3.3V TPS25200DRVR, USB: TPS25200DRVR
// Double Pulse: 90V 700A
// More info, photos, graphs https://teamtriforceuk.com/a400s-v3/
...
#define NTC_TEMP(adc_ind)		hw_a400s_get_temp()
...
#define AUX_ON()				hw_a400s_aux(1)
#define AUX_OFF()				hw_a400s_aux(0)
...
// Hardware protection
#define HW_RESET_DRV_FAULTS()	hw_a400s_reset_faults()
#define ENABLE_GATE()			palClearPad(GPIOC, 5)
#define DISABLE_GATE()			palSetPad(GPIOC, 5)
#define IS_DRV_FAULT()			hw_a400s_drv_fault_check() 
...
#define MCCONF_FOC_F_ZV					35000.0 	// 35kHz default ZVF (17.5kHz switching) Max frequency that HFI will work
...
#define MCCONF_FOC_CURRENT_SAMPLE_MODE	FOC_CURRENT_SAMPLE_MODE_ALL_SENSORS // Use all sensors, 95% duty limit stops this causing problems at high duty.
...
#define HW_NAME					"A400S_V3"
 

// HW-specific functions
float hw_a400s_get_temp(void);
void hw_a400s_reset_faults(void);
bool hw_a400s_hardware_handshake(void);
bool hw_a400s_drv_fault_check(void);
void hw_a400s_aux(bool);

#endif /* HW_A400S_V3_CORE_H_ */
