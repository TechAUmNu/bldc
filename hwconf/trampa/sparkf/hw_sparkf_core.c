/*
	Copyright 2012-2024 Benjamin Vedder	benjamin@vedder.se
...
static lbm_value ext_sf_read_rel(lbm_value *args, lbm_uint argn) {
	(void)args; (void)argn;
...
void hw_init_gpio(void) {
	...
	// Relay State
	palSetPadMode(REL_GPIO, REL_PIN, PAL_MODE_INPUT);
