...
void hw_init_gpio(void) {
	...
	palSetPadMode(FRONT_LIGHT_GPIO, FRONT_LIGHT_PIN, PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_HIGHEST);
	palSetPadMode(REAR_LIGHT_GPIO, REAR_LIGHT_PIN, PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_HIGHEST);
	FRONT_LIGHT_OFF();
	REAR_LIGHT_OFF();
